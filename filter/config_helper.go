...
func SafeDecodeConfig(filterType string, config map[interface{}]interface{}, result interface{}) {
...
func ValidateRequiredFields(filterType string, fields map[string]interface{}) {
